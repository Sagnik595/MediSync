...
const Nav = () => {
  ...
  return (
    <>
      <div>
        <div className="pt-4 px-5 pb-2 flex flex-wrap border-gray-500 border-[0_0_1px_0]">
          <div className="flex">
            ...
            <h1 className="cursor-pointer ml-3 text-3xl font-semibold">
          ...
          <div className="ml-auto">
            <button
              ...
              className="px-6.5 py-1.5 rounded-[25px_25px_25px_25px] bg-blue-500 text-white hover:bg-blue-600 transition-colors cursor-pointer"
            >
              LOGOUT
            </button>
          </div>
