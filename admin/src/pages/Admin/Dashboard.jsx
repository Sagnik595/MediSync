...
const Dashboard = () => {
  const { aToken, backendurl, getallDoctors, doctors } =
  ...
  const cancelAppointment = async (item) => {
    try {
      const deletedDoc = await axios.delete(
        backendurl + "api/admin/deletedoc",
        {
    ...
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm max-w-2xl">
        ...
        <div className="px-4 py-3.5 border-b border-gray-200 flex items-center gap-2">
          ...
          <h2 className="text-sm font-medium text-gray-700">Doctors Added</h2>
        </div>
