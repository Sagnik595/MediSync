...
const TIME_SLOTS = ['8:00 am', '8:30 am', '9:00 am', '9:30 am', '10:00 am', '10:30 am', '11:00 am', '11:30 am']
...
const Appointments = () => {
  ...
  if (!doctor) return (
    <><Nav /><p className="text-center py-32 text-gray-400">Doctor not found.</p><Footer /></>
  )
      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        <div className="flex flex-col sm:flex-row gap-6 border border-gray-200 rounded-2xl overflow-hidden mb-10">
          <div className="bg-blue-100 sm:w-56 shrink-0 flex items-end justify-center">
            <img src={doctor.image} alt={doctor.name} className="w-full h-52 object-cover object-top" />
          </div>
          <div className="p-6 flex flex-col justify-center">
            ...
            <div className="mb-3">
              ...
              <p className="text-gray-500 text-sm leading-relaxed">{doctor.about}</p>
            </div>
            <p className="text-sm text-gray-700">
              Appointment fee: <span className="text-gray-900 font-semibold">${doctor.fees}</span>
            </p>
          </div>
        </div>
        ...
        {/* Booking Slots */}
        <div className="mb-10">
          <h2 className="text-base font-semibold text-gray-800 mb-4">Booking slots</h2>
        ...
        {relatedDoctors.length > 0 && (
          <div>
            <h2 className="text-xl font-semibold text-gray-900 text-center mb-1">Related Doctors</h2>
              ...
              {relatedDoctors.map(d => (
                ...
                >
                  ...
                  <div className="p-3">
                    ...
                    <p className="text-gray-800 text-sm font-medium truncate">{d.name}</p>
                    <p className="text-gray-400 text-xs truncate">{d.speciality}</p>
                  </div>
                </div>
              ))}
            </div>
